...
contract KittyMarketPlace is IKittyMarketPlace, Ownable {
    ...
    function _removeOffer(uint256 tokenId) internal {
        ...
        uint256 lastIndex = offers.length -1; //TODO should use safemath here
        if (toBeRemoved.index < lastIndex) {
            // not the last offer in the array
